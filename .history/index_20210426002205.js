...
const getStudentCourse = async (studentId)=>{
      ...
      let studentCourse = testIdArray.filter(num => {
            let [returnArray,  testIndx,  testObj,courseId ] =[[], num-1, data['tests.csv'][testIndx], testObj['course_id'] ]
            // let testIndx = num-1
            ...
            if(includeObj[courseId]){
                  ...
                  returnArray.push (data['courses.csv'][courseIndx])
            }
      })
